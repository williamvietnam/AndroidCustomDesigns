...
public class CircleTextAndImageView extends FrameLayout {
    ...
    public CircleTextAndImageView(Context context, int avatarResourceId) {
        super(context);
        avatar = avatarResourceId;
        addChildren(context);
    }

    public CircleTextAndImageView(Context context, int backgroundColor, float textSize, int textColor, String text) {
        super(context);
    ...
    public CircleTextAndImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void applyAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            backgroundColor = a.getColor(R.styleable.circleInitialsView_attrs_circleInitialsView_backgroundColor, getResources().getColor(R.color.color_FBD4C2));
